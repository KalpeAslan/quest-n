...
import { QuestsPageStyles } from "./questsPage.styles";
...
import { Quests } from "@modules/account/components/quests";
...
const QuestsPage: NextPage = () => {
  ...
  useEffect(() => {
    ...
    dispatch(
      sendAnalyticsDataThunk({
        ...
        options: { event_property_current_page: "/profile/quests" },
      }),
    );
    setTracked(true);
  ...
  return (
    <div className="background-other">
      <QuestsPageStyles mt={5} mb={isMd ? 16 : 5}>
        <Box mb={{ xs: 2, md: 3 }}>
          <Box
            ...
            component="h3"
          >
            <Trans id={"xdshfjk-234hkjdf"}>Quests</Trans>
          </Box>
          <p className={"c-font-16-18 c-font-color"}>
            <Trans id="3xywtoiLuJnfWz6Pk8nw5w-questsPage">
              Here are the quests you participate in.
            </Trans>
          </p>
        </Box>
